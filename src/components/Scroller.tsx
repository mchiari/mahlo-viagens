...
export const Scroller = () => {
    ...
    useEffect(() => {
        ...
        gsap.set('.mainScroller', { position: 'fixed', background: '#fff', width: '100%', maxWidth: '100%', height: '80%', top: 0, left: '50%', x: '-50%' })
    ...
    return (
        <div className="mainScroller w-full h-full">
            {/* <Header /> */}
            <svg viewBox="0 0 1200 800" xmlns="http://www.w3.org/2000/svg">
                ...
                <text className='text-9xl' fill="#fff" x="38%" y="200">VIAGENS</text>

                <polyline className="arrow" fill="#fff" points="599,250 599,289 590,279 590,282 600,292 610,282 610,279 601,289 601,250" />

                <g mask="url(#m)">
                    <rect fill="#fff" width="100%" height="100%" />
                    <text className="text-9xl font-['Passion One']" x="38%" y="200" fill="#162a43">ALEGRIA</text>
                    <text className="text-2xl font-['Passion One']" x="38%" y="400" fill="#162a43">MAHLO VIAGENS</text>
                    <text onClick={() => navigate('/home')} className="text-2xl font-['Passion One'] cursor-pointer" x="38%" y="440" fill="#162a43">Clique aqui para embarcar nessa aventura!</text>
                </g>
